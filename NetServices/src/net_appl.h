 ...
 * 08-Apr-94     Thang Trinh        Add VxWorks broadcast support.
 * 20-Nov-95     Thang Trinh        Version 2.0 release to support generic
 *				    application names.
 *
 * Description:
...
#define MAXTASKS	(APP17_TASK+1)	/* max number of client tasks */
