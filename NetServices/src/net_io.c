 ...
 *   Date            By               Description
 * 
 * 13-Oct-93     Thang Trinh        Initial release (v1.0) for SunOS 4.1.x
 *				    and Solaris 2.x.
 * 20-Nov-95	 Thang Trinh	    Version 2.0 release to support little-
...
int net_send (int sockfd,     /* endpoint socket descriptor */
              ...
              io_mode mode)   /* send I/O mode */
{
    ...
    static struct msg_hdr_dcl msg_hdr = {NET_HDR_ID, 0};
...
static int net_read_excess (int sockfd,		/* endpoint socket descriptor */
																												int nexcess)	/* endpoint socket descriptor */
{
