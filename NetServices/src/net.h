 ...
 *   Date            By               Description
 *
 * 13-Oct-93       T. Trinh         Initial release (v1.0).
 * 08-Apr-94       T. Trinh         Add VxWorks broadcast support.
 *
 * Description:
...
#define NET_MAX_FD	128		/* max number of open socket desc */

#define NET_MIN_MSG_LEN (sizeof (char)) /* minimum message length */
#define NET_MAX_MSG_LEN 514*1024	/* maximum message length */
